...
namespace MedabilNavisworks
{
    ...
    [Command("MedabilButtonLimpar", Icon = "BTLIMPAR_16.png", LargeIcon = "BTLIMPAR_32.png", DisplayName = "Limpar", ToolTip = "Limpa as informação do último processamento de dados")]
    [Command("MedabilButton1", Icon = "BT1_16.png", LargeIcon = "BT1_32.png", DisplayName = "Processar", ToolTip = "Processa as informações dos arquivos anexados e preenche os dados da aba Medabil de propriedades")]
    [Command("MedabilButton2", Icon = "BT2_16.png", LargeIcon = "BT2_32.png", DisplayName = "Importar SKIDs", ToolTip = "Carregar informações de SKID do relatório SAP")]
    [Command("MedabilButton3", Icon = "calendar_16_16.png", LargeIcon = "calendar_32_32.png", DisplayName = "Definir Data Execução", ToolTip = "Define a data de execução dos elementos selecionados")]
    [Command("MedabilButton4", Icon = "calendarRemove_16_16.png", LargeIcon = "calendarRemove_32_32.png", DisplayName = "Remove Data Execução", ToolTip = "Remove a data de execução dos elementos selecionados")]
    [Command("MedabilButton5", Icon = "setsVps_16.png", LargeIcon = "setsVps_32.png", DisplayName = "Sets e Viewpoints", ToolTip = "Gera os Sets e Viewpoints de forma organizada para os elementos executados")]
    [Command("MedabilButton6", Icon = "CalcSelection_16.png", LargeIcon = "CalcSelection_32.png", DisplayName = "Medabil/Tipo", ToolTip = "Apresenta o somatório das propriedades dos elementos selecionados separados por Medabil/Tipo")]
    [Command("MedabilButton7", Icon = "CalcSelection_16.png", LargeIcon = "CalcSelection_32.png", DisplayName = "IFC/OBJECTTYPE", ToolTip = "Apresenta o somatório das propriedades dos elementos selecionados separados por IFC/OBJECTTYPE")]
    [Command("MedabilButton8", Icon = "excelExport_16.png", LargeIcon = "excelExport_32.png", DisplayName = "Exportar Sets", ToolTip = "Exporta os somatórios das propriedades dos elementos dos sets de execução")]
    [Command("Sobre", Icon = "projetabim_16.png", LargeIcon = "projetabim_32.png", DisplayName = "Medabil", ToolTip = "Sobre")]
